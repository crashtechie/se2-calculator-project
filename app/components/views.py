...
class ComponentDetailView(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        if component.materials:
            ...
            ores = {
                str(ore.ore_id): ore for ore in Ore.objects.filter(ore_id__in=ore_ids)
            }
...
class ComponentUpdateView(UpdateView):
    ...
    def get_success_url(self):
        ...
        return reverse_lazy(
            "components:component_detail", kwargs={"pk": self.object.pk}
        )
    ...
    def form_valid(self, form):
        ...
        messages.success(
            self.request, f'Component "{component.name}" updated successfully.'
        )
...
class ComponentDeleteView(DeleteView):
    ...
    def get_context_data(self, **kwargs):
        ...
        if component.materials:
            ...
            for ore_id_str, quantity in component.materials.items():
                ...
                formatted_materials.append(
                    {
                        "ore_name": ore.name if ore else "Unknown Ore",
                        "quantity": quantity,
                    }
                )
    ...
    def delete(self, request, *args, **kwargs):
        ...
        messages.success(
            request, f'Component "{component_name}" has been deleted successfully.'
        )

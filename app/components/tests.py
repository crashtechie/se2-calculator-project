...
class ComponentModelCreationTests(TestCase):
    ...
    def setUp(self):
        ...
        self.iron = Ore.objects.create(name="Test Iron Ore", mass=1.0)
        self.copper = Ore.objects.create(name="Test Copper Ore", mass=0.8)
    ...
    def test_create_component_minimal_fields(self):
        ...
        component = Component.objects.create(name="Minimal Component")
...
class ComponentFieldValidationTests(TestCase):
    ...
    def test_description_can_be_blank(self):
        ...
        component = Component.objects.create(name="No Description", description="")
        self.assertEqual(component.description, "")

    def test_fabricator_type_can_be_blank(self):
        """Test that fabricator_type field can be empty."""
        component = Component.objects.create(name="No Fabricator", fabricator_type="")
        self.assertEqual(component.fabricator_type, "")
    ...
    def test_crafting_time_numeric_values(self):
        ...
        for i, value in enumerate(test_values):
            component = Component.objects.create(
                name=f"Time Test {i}", crafting_time=value
            )
    ...
    def test_mass_numeric_values(self):
        ...
        for i, value in enumerate(test_values):
            component = Component.objects.create(name=f"Mass Test {i}", mass=value)
...
class ComponentTimestampTests(TestCase):
    ...
    def test_created_and_updated_match_on_creation(self):
        ...
        self.assertAlmostEqual(
            component.created_at, component.updated_at, delta=timedelta(milliseconds=1)
        )
...
class ComponentMaterialsJSONFieldTests(TestCase):
    ...
    def test_materials_stores_single_ore(self):
        ...
        component = Component.objects.create(
            name="Single Material", materials={str(self.iron.ore_id): 10}
        )
    ...
    def test_materials_stores_multiple_ores(self):
        ...
        component = Component.objects.create(
            ...
            materials={str(self.iron.ore_id): 7, str(self.copper.ore_id): 3},
        )
    ...
    def test_materials_persist_after_save(self):
        ...
        component = Component.objects.create(
            name="Persist Test", materials={str(self.iron.ore_id): 5}
        )
    ...
    def test_materials_can_be_updated(self):
        ...
        component = Component.objects.create(
            name="Update Materials", materials={str(self.iron.ore_id): 5}
        )
...
class ComponentMaterialValidationTests(TestCase):
    ...
    def test_validate_materials_with_valid_ores(self):
        ...
        component = Component.objects.create(
            name="Valid Component", materials={str(self.iron.ore_id): 10}
        )
    ...
    def test_validate_materials_with_invalid_ore_id(self):
        ...
        component = Component(
            name="Invalid Ore", materials={"00000000-0000-0000-0000-000000000000": 10}
        )
    ...
    def test_validate_materials_with_negative_quantity(self):
        ...
        component = Component(
            name="Negative Quantity", materials={str(self.iron.ore_id): -5}
        )
    ...
    def test_validate_materials_with_zero_quantity(self):
        ...
        component = Component(
            name="Zero Quantity", materials={str(self.iron.ore_id): 0}
        )
    ...
    def test_validate_materials_empty_materials(self):
        ...
        component = Component.objects.create(name="Empty Materials", materials={})
    ...
    def test_clean_raises_validation_error(self):
        ...
        component = Component(
            name="Clean Test", materials={"00000000-0000-0000-0000-000000000000": 10}
        )
...
class ComponentMaterialOresRelationshipTests(TestCase):
    ...
    def test_get_material_ores_single_ore(self):
        ...
        component = Component.objects.create(
            name="Single Ore", materials={str(self.iron.ore_id): 10}
        )
    ...
    def test_get_material_ores_empty_materials(self):
        ...
        component = Component.objects.create(name="No Materials", materials={})
...
class ComponentIntegrationTests(TestCase):
    ...
    def test_complete_component_creation_workflow(self):
        ...
        component = Component.objects.create(
            ...
            materials={str(self.iron.ore_id): 10, str(self.copper.ore_id): 5},
    ...
    def test_component_update_preserves_relationships(self):
        ...
        component = Component.objects.create(
            name="Update Relationship Test", materials={str(self.iron.ore_id): 10}
        )
    ...
    def test_component_deletion_does_not_affect_ores(self):
        ...
        component = Component.objects.create(
            name="Delete Test", materials={str(self.iron.ore_id): 10}
        )

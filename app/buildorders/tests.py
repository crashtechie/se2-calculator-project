...
def create_component(name="Steel Plate", materials=None, fabricator_type="Assembler", crafting_time=1.0, mass=1.0):
...
class BuildOrderValidationTests(TestCase):
    ...
    def test_save_invalidates_cache(self):
        ...
        order = create_build_order(
            name="Cache Order",
            blocks_dict={str(block.block_id): 1}
        )
        # Get cached summary
...
class BuildOrderCalculationTests(TestCase):
    ...
    def test_calculate_total_mass_with_one_block(self):
        ...
        order = create_build_order(
            name="Single Block Order",
            blocks_dict={str(block.block_id): 3}
        )
    ...
    def test_calculate_required_components_with_one_block(self):
        ...
        block = create_block(
            name="Test Block",
            components_dict={str(comp.component_id): 5}
        )
        order = create_build_order(
            name="Single Block Order",
            blocks_dict={str(block.block_id): 2}
        )
    ...
    def test_calculate_required_components_with_multiple_blocks(self):
        ...
        block1 = create_block(
            name="Block 1",
            components_dict={str(comp1.component_id): 3}
        )
        block2 = create_block(
            name="Block 2",
            components_dict={str(comp2.component_id): 2}
        )
        order = create_build_order(
            name="Multi Block Order",
            blocks_dict={
    ...
    def test_calculate_required_components_aggregates_same_component(self):
        ...
        block2 = create_block(
            name="Block 2",
            components_dict={str(comp.component_id): 3}
        )
        order = create_build_order(
    ...
    def test_calculate_required_ores_traverses_to_ores(self):
        ...
        comp = create_component(
            name="Steel Plate",
            materials={str(ore.ore_id): 3.0}
        )
        block = create_block(
            name="Test Block",
            components_dict={str(comp.component_id): 2}
        )
        order = create_build_order(
            name="Ore Order",
            blocks_dict={str(block.block_id): 5}
    ...
    def test_calculate_required_ores_aggregates_same_ore(self):
        ...
        block = create_block(
            name="Test Block",
            components_dict={
                str(comp1.component_id): 1,
                str(comp2.component_id): 1
            }
        )
        order = create_build_order(
            name="Aggregated Ore Order",
            blocks_dict={str(block.block_id): 2}
        )
        ores = order.calculate_required_ores()
    ...
    def test_calculate_required_ores_handles_multiple_components(self):
        ...
        comp = create_component(
            name="Computer",
            materials={str(ore1.ore_id): 1.0, str(ore2.ore_id): 2.0}
        )
        block = create_block(
            name="Test Block",
            components_dict={str(comp.component_id): 3}
    ...
    def test_calculate_fabricator_times_groups_by_type(self):
        ...
        block = create_block(
            name="Test Block",
            components_dict={
                str(comp1.component_id): 2,
                str(comp2.component_id): 3
            }
        )
        order = create_build_order(
            name="Fabricator Order",
            blocks_dict={str(block.block_id): 1}
        )
    ...
    def test_calculate_fabricator_times_sums_times_correctly(self):
        ...
        block = create_block(
            ...
            components_dict={
                str(comp1.component_id): 2,
                str(comp2.component_id): 4
            }
        )
        order = create_build_order(
            name="Sum Times Order",
            blocks_dict={str(block.block_id): 3}
        )
        times = order.calculate_fabricator_times()
    ...
    def test_get_calculation_summary_returns_all_data(self):
        ...
        self.assertEqual(summary['required_components'][str(comp.component_id)], 6)  # 2 * 3
    ...
    def test_get_ores_with_details_returns_correct_format(self):
        ...
        order = create_build_order(
            name="Ore Details Order",
            blocks_dict={str(block.block_id): 4}
        )
...
class BuildOrderCachingTests(TestCase):
    ...
    def test_validate_blocks_rejects_non_numeric_quantities(self):
        ...
        order = BuildOrder(
            ...
            blocks={str(block.block_id): "not a number"}
        )
        ...
        try:
            ...
            if not errors:
                total = order.calculate_total_mass()
...
class BuildOrderPropertyBasedTests(TestCase):
    ...
    def test_component_requirements_scale_linearly(self):
        ...
        order10 = create_build_order(
            name="Order 10",
            blocks_dict={str(block.block_id): 10}
        )
        comps10 = order10.calculate_required_components()
        
        # Component requirements should scale linearly
        self.assertEqual(comps10[str(comp.component_id)], comps2[str(comp.component_id)] * 5)
    ...
    def test_adding_zero_blocks_doesnt_change_results(self):
        ...
        order1 = create_build_order(
            name="Order 1",
            blocks_dict={str(block1.block_id): 5}
        )
        mass1 = order1.calculate_total_mass()
    ...
    def test_doubling_quantities_doubles_results(self):
        ...
        order2 = create_build_order(
            name="Order 2",
            blocks_dict={str(block.block_id): 8}
        )
...
class BuildOrderIntegrationTests(TestCase):
    ...
    def test_multiple_blocks_with_shared_components_aggregation_correct(self):
        ...
        self.assertEqual(summary['required_components'][str(shared_comp.component_id)], 14)
    ...
    def test_order_with_fixture_data_calculations_match_expected(self):
        ...
        order = create_build_order(
            name="Fixture Order",
            blocks_dict={str(armor_block.block_id): 10}
        )
        ...
        self.assertEqual(summary['required_components'][str(steel_plate.component_id)], 250)
        ...
        self.assertEqual(component_details[0]['total_mass'], 5000.0)  # 20 kg/plate * 250

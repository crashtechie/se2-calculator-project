    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "mass",
                    models.FloatField(help_text="Total mass of the block in kilograms"),
                ),
                (
                    "components",
                    models.JSONField(
                ...
                (
                    "health",
                    models.FloatField(help_text="Block health/integrity points"),
                ),
                (
                    "pcu",
                    models.IntegerField(
                ...
                (
                    "snap_size",
                    models.FloatField(help_text="Grid snap size for placement"),
                ),
                (
                    "input_mass",
                    models.IntegerField(help_text="Input mass capacity in kg"),
                ),
                (
                    "output_mass",
                    models.IntegerField(help_text="Output mass capacity in kg"),
                ),
                (
                    "consumer_type",
                    models.CharField(

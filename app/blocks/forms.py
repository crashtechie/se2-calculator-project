...
class BlockForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "consumer_rate": forms.NumberInput(
                attrs={
                    "class": "form-control",
            ...
            "producer_rate": forms.NumberInput(
                attrs={
                    "class": "form-control",
            ...
            "storage_capacity": forms.NumberInput(
                attrs={
                    "class": "form-control",

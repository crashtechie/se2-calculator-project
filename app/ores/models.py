...
class Ore(models.Model):
    ...
    name = models.CharField(
        max_length=100, unique=True, help_text="Unique name of the ore."
    )
    ...
    created_at = models.DateTimeField(
        auto_now_add=True, help_text="Timestamp when the ore was created."
    )

    updated_at = models.DateTimeField(
        auto_now=True, help_text="Timestamp when the ore was last updated."
    )
